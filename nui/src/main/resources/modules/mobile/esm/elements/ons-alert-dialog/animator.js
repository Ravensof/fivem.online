...
export var AlertDialogAnimator = function (_BaseAnimator) {
	...
	function AlertDialogAnimator() {
		...
		return _possibleConstructorReturn(this, (AlertDialogAnimator.__proto__ || _Object$getPrototypeOf(AlertDialogAnimator)).call(this, {
			timing: timing,
			delay: delay,
			duration: duration
		}));
...
export var AndroidAlertDialogAnimator = function (_AlertDialogAnimator) {
	...
	function AndroidAlertDialogAnimator() {
		...
		return _possibleConstructorReturn(this, (AndroidAlertDialogAnimator.__proto__ || _Object$getPrototypeOf(AndroidAlertDialogAnimator)).call(this, {
			duration: duration,
			timing: timing,
			delay: delay
		}));
	...
	_createClass(AndroidAlertDialogAnimator, [{
		...
		value: function show(dialog, callback) {
			...
			animit.runAll(animit(dialog._mask, this.def).default({opacity: 0}, {opacity: 1}), animit(dialog._dialog, this.def).default({
				...
				opacity: 0
			}, {transform: 'translate3d(-50%, -50%, 0) scale3d(1, 1, 1)', opacity: 1}).queue(function (done) {
				callback();
				done();
			}));
		}
		...
		value: function hide(dialog, callback) {
			...
			animit.runAll(animit(dialog._mask, this.def).default({opacity: 1}, {opacity: 0}), animit(dialog._dialog, this.def).default({
				...
				opacity: 1
			}, {transform: 'translate3d(-50%, -50%, 0) scale3d(.9, .9, 1)', opacity: 0}).queue(function (done) {
				callback();
				done();
			}));
		}
...
export var IOSAlertDialogAnimator = function (_AlertDialogAnimator2) {
	...
	function IOSAlertDialogAnimator() {
		...
		return _possibleConstructorReturn(this, (IOSAlertDialogAnimator.__proto__ || _Object$getPrototypeOf(IOSAlertDialogAnimator)).call(this, {
			duration: duration,
			timing: timing,
			delay: delay
		}));
