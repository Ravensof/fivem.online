...
var IOSFadeNavigatorAnimator = function (_NavigatorAnimator) {
	...
	function IOSFadeNavigatorAnimator() {
		...
		return _possibleConstructorReturn(this, (IOSFadeNavigatorAnimator.__proto__ || _Object$getPrototypeOf(IOSFadeNavigatorAnimator)).call(this, {
			timing: timing,
			delay: delay,
			duration: duration
		}));
	...
	_createClass(IOSFadeNavigatorAnimator, [{
		...
		value: function push(enterPage, leavePage, callback) {
			...
			animit.runAll(animit(enterPage, this.def).default({transform: transform, opacity: 0}, {
				transform: transform,
				opacity: 1
			}).queue(function (done) {
				unblock();
		...
		value: function pop(enterPage, leavePage, callback) {
			...
			animit.runAll(animit(leavePage, this.def).default({transform: transform, opacity: 1}, {
				transform: transform,
				opacity: 0
			}).queue(function (done) {
				unblock();
