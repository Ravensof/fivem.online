...
var IOSLiftNavigatorAnimator = function (_NavigatorAnimator) {
	...
	function IOSLiftNavigatorAnimator() {
		...
		var _this = _possibleConstructorReturn(this, (IOSLiftNavigatorAnimator.__proto__ || _Object$getPrototypeOf(IOSLiftNavigatorAnimator)).call(this, {
			timing: timing,
			delay: delay,
			duration: duration
		}));
	...
	_createClass(IOSLiftNavigatorAnimator, [{
		...
		value: function push(enterPage, leavePage, callback) {
			...
			animit.runAll(animit(enterPage, this.def).default({transform: 'translate3D(0, 100%, 0)'}, {transform: 'translate3D(0, 0, 0)'}), animit(leavePage, this.def).default({
				transform: 'translate3D(0, 0, 0)',
				opacity: 1
			}, {transform: 'translate3D(0, -10%, 0)', opacity: .9}).queue(function (done) {
