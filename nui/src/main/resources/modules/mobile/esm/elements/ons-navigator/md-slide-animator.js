...
var MDSlideNavigatorAnimator = function (_NavigatorAnimator) {
	...
	function MDSlideNavigatorAnimator() {
		...
		var _this = _possibleConstructorReturn(this, (MDSlideNavigatorAnimator.__proto__ || _Object$getPrototypeOf(MDSlideNavigatorAnimator)).call(this, {
			timing: timing,
			delay: delay,
			duration: duration
		}));
	...
	_createClass(MDSlideNavigatorAnimator, [{
		...
		value: function push(enterPage, leavePage, callback) {
			...
			animit.runAll(animit(this.backgroundMask, this.def).default({
				...
				opacity: 0
			}, {opacity: this.blackMaskOpacity}).queue(function (done) {
		...
		value: function pop(enterPage, leavePage, callback) {
			...
			animit.runAll(animit(this.backgroundMask, this.def).default({
				...
				transform: 'translate3d(0, 0, 0)',
				opacity: 1
			}), animit(leavePage, this.def).default({transform: 'translate3d(0, 0, 0)'}, {transform: 'translate3d(100%, 0, 0)'}).queue(function (done) {
				unblock();
				callback();
				done();
			}));
