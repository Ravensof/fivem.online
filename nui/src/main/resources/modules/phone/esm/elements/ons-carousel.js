...
var CarouselElement = function (_BaseElement) {
	...
	_createClass(CarouselElement, [{
		...
		value: function _onChange(eventName, _ref2) {
			...
			util.triggerElementEvent(this, eventName, {
				carousel: this,
		...
		value: function setActiveIndex(index) {
			...
			options = _extends({
				...
				animationOptions: this.hasAttribute('animation-options') ? util.animationOptionsParse(this.getAttribute('animation-options')) : {
					duration: .3,
