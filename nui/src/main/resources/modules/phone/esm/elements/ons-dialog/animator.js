...
export var DialogAnimator = function (_BaseAnimator) {
	...
	function DialogAnimator() {
		...
		return _possibleConstructorReturn(this, (DialogAnimator.__proto__ || _Object$getPrototypeOf(DialogAnimator)).call(this, {
			timing: timing,
			delay: delay,
			duration: duration
		}));
...
export var AndroidDialogAnimator = function (_DialogAnimator) {
	...
	function AndroidDialogAnimator() {
		...
		return _possibleConstructorReturn(this, (AndroidDialogAnimator.__proto__ || _Object$getPrototypeOf(AndroidDialogAnimator)).call(this, {
			timing: timing,
			delay: delay,
			duration: duration
		}));
	...
	_createClass(AndroidDialogAnimator, [{
		...
		value: function show(dialog, callback) {
			...
			animit.runAll(animit(dialog._mask, this.def).default({opacity: 0}, {opacity: 1}), animit(dialog._dialog, this.def).default({
				...
				opacity: 0
			}, {transform: 'translate3d(-50%, -50%, 0)', opacity: 1}).queue(function (done) {
				callback();
				done();
			}));
		}
		...
		value: function hide(dialog, callback) {
			...
			animit.runAll(animit(dialog._mask, this.def).default({opacity: 1}, {opacity: 0}), animit(dialog._dialog, this.def).default({
				transform: 'translate3d(-50%, -50%, 0)',
				opacity: 1
			}, {transform: 'translate3d(-50%, -60%, 0)', opacity: 0}).queue(function (done) {
				callback();
				done();
			}));
		}
...
export var IOSDialogAnimator = function (_DialogAnimator2) {
	...
	function IOSDialogAnimator() {
		...
		var _this3 = _possibleConstructorReturn(this, (IOSDialogAnimator.__proto__ || _Object$getPrototypeOf(IOSDialogAnimator)).call(this, {
			timing: timing,
			delay: delay,
			duration: duration
		}));
...
export var SlideDialogAnimator = function (_DialogAnimator3) {
	...
	function SlideDialogAnimator() {
		...
		var _this4 = _possibleConstructorReturn(this, (SlideDialogAnimator.__proto__ || _Object$getPrototypeOf(SlideDialogAnimator)).call(this, {
			timing: timing,
			delay: delay,
			duration: duration
		}));
