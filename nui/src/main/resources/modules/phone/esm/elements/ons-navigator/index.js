...
import {defaultPageLoader, instantPageLoader, PageLoader} from '../../ons/page-loader';
/*
			...
			return new _Promise(function (resolve) {
				...
				var done = function done() {
					update().then(function () {
						...
						enterPage._show();
						util.triggerElementEvent(_this4, 'postpop', {
							leavePage: leavePage,
							enterPage: enterPage,
							navigator: _this4
						});
			...
			return update().then(function () {
				...
				return new _Promise(function (resolve) {
					var done = function done() {
						...
						util.triggerElementEvent(_this6, 'postpush', {
							leavePage: leavePage,
							enterPage: enterPage,
							navigator: _this6
						});
